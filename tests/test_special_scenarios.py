...
class TestComplexFieldNames:
    ...
    def test_field_with_numbers(self, clean_env: pytest.MonkeyPatch) -> None:
    ...
    def test_field_with_double_underscore(self, clean_env: pytest.MonkeyPatch) -> None:
...
class TestSettingsInheritance:
    ...
    def test_inherited_settings_validation(self, clean_env: pytest.MonkeyPatch) -> None:
...
class TestEdgeCaseSettings:
    ...
    @pytest.mark.usefixtures("clean_env")
    def test_settings_with_only_defaults(self) -> None:
    ...
    def test_settings_with_single_field(self, clean_env: pytest.MonkeyPatch) -> None:
    ...
    @pytest.mark.usefixtures("clean_env")
    def test_settings_with_many_fields(self) -> None:
...
class TestURLAndPathValues:
    ...
    def test_url_values(self, clean_env: pytest.MonkeyPatch) -> None:
    ...
    def test_file_path_values(self, clean_env: pytest.MonkeyPatch) -> None:
    ...
    def test_windows_path_values(self, clean_env: pytest.MonkeyPatch) -> None:
...
class TestJSONAndStructuredData:
    ...
    def test_json_string_as_string(self, clean_env: pytest.MonkeyPatch) -> None:
...
class TestSpecialCharactersInValues:
    ...
    def test_special_chars_in_strings(self, clean_env: pytest.MonkeyPatch) -> None:
    ...
    def test_unicode_in_values(self, clean_env: pytest.MonkeyPatch) -> None:
    ...
    def test_emoji_in_values(self, clean_env: pytest.MonkeyPatch) -> None:
