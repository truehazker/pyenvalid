...
class TestValidateSettingsEdgeCases:
    ...
    @pytest.mark.usefixtures("clean_env")
    def test_settings_with_optional_fields(self) -> None:
    ...
    def test_settings_with_validator_error(self, clean_env: pytest.MonkeyPatch) -> None:
    ...
    @pytest.mark.usefixtures("clean_env")
    def test_all_defaults_settings_success(self) -> None:
    ...
    def test_settings_with_union_types(self, clean_env: pytest.MonkeyPatch) -> None:
    ...
    @pytest.mark.usefixtures("clean_env")
    def test_settings_with_list_field(self) -> None:
    ...
    @pytest.mark.usefixtures("clean_env")
    def test_settings_with_dict_field(self) -> None:
    ...
    @pytest.mark.usefixtures("clean_env")
    def test_multiple_missing_with_types(self) -> None:
    ...
    def test_settings_with_complex_literal(self, clean_env: pytest.MonkeyPatch) -> None:
    ...
    def test_settings_with_float_field(self, clean_env: pytest.MonkeyPatch) -> None:
    ...
    def test_invalid_float_type(self, clean_env: pytest.MonkeyPatch) -> None:
    ...
    def test_settings_with_env_prefix(self, clean_env: pytest.MonkeyPatch) -> None:
    ...
    def test_case_sensitive_settings(self, clean_env: pytest.MonkeyPatch) -> None:
    ...
    def test_settings_with_alias(self, clean_env: pytest.MonkeyPatch) -> None:
    ...
    def test_settings_with_zero_values(self, clean_env: pytest.MonkeyPatch) -> None:
...
class TestValidateSettingsTypeCoercion:
    ...
    def test_int_from_string(self, clean_env: pytest.MonkeyPatch) -> None:
    ...
    def test_bool_from_various_strings(self, clean_env: pytest.MonkeyPatch) -> None:
    ...
    def test_float_from_int_string(self, clean_env: pytest.MonkeyPatch) -> None:
    ...
    def test_scientific_notation_float(self, clean_env: pytest.MonkeyPatch) -> None:
...
class TestValidateSettingsErrorMessages:
    ...
    @pytest.mark.usefixtures("clean_env")
    def test_error_contains_field_and_type(self) -> None:
    ...
    @pytest.mark.usefixtures("clean_env")
    def test_error_message_readable_format(self) -> None:
